...
public class DataSelector {
    public static void findFilmsByYearRange(Connection conn, int startYear, int endYear) {
    ...
    public static void getActorsByFilmTitle(Connection conn, String filmTitle) {
    ...
    public static void getFilmsByActorName(Connection conn, String actorName) {
